...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=1 AND jadwal.paralel_bahasa_ing='B';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 1 - Bahasa Inggris-B</title>
