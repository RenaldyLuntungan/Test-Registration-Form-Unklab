...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=1 AND jadwal.paralel_matematika='A';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 1 - Matematika-A</title>
...
Waktu &emsp;&emsp;: &ensp;21/05/2020 13:00<br>
