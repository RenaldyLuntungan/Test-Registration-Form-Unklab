...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=1 AND jadwal.paralel_kesehatan='B';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 1 - Kesehatan-B</title>
...
Waktu &emsp;&emsp;: &ensp;21/05/2020 15:00<br>
