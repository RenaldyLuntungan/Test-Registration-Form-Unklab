...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=2 AND jadwal.paralel_bahasa_ing='A';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 2 - Bahasa Inggris-A</title>
