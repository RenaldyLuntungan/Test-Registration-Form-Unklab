...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=2 AND jadwal.paralel_matematika='B';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 2 - Matematika-B</title>
...
<h2>Berita Acara</h2>
Gelombang : &ensp;2<br>
Test &emsp;&emsp;&emsp;: &ensp;Matematika<br>
Paralel&emsp;&emsp;: &ensp;B<br>
Waktu &emsp;&emsp;: &ensp;20/05/2020 09:00<br>
Tempat&ensp;&nbsp;&emsp;: &ensp;GK1-101<br><br>
                <table border="1">
