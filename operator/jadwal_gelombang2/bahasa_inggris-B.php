...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=2 AND jadwal.paralel_bahasa_ing='B';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 2 - Bahasa Inggris-B</title>
...
Tempat&ensp;&nbsp;&emsp;: &ensp;GA-202<br><br>
                <table border="1">
