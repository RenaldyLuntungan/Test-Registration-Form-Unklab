...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=3;");
?>
...
<div id="content">
  ...
  <!-- End of Topbar -->
        ...
        <div class="container-fluid">
          ...
          <a href="jadwal_gelombang3/bahasa_inggris-A.php">[Bahasa Inggris - A]</a>&emsp;
          <a href="jadwal_gelombang3/bahasa_inggris-B.php">[Bahasa Inggris - B]</a>&emsp;
          <a href="jadwal_gelombang3/bahasa_inggris-C.php">[Bahasa Inggris - C]</a>&emsp;
          <a href="jadwal_gelombang3/bahasa_inggris-D.php">[Bahasa Inggris - D]</a><br>
          <a href="jadwal_gelombang3/kesehatan-A.php">[Kesehatan - A]</a>&emsp;
          <a href="jadwal_gelombang3/kesehatan-B.php">[Kesehatan - B]</a><br>
          <a href="jadwal_gelombang3/matematika-A.php">[Matematika - A]</a>&emsp;
          <a href="jadwal_gelombang3/matematika-B.php">[Matematika - B]</a>
          <br><br>
          <h1 class="h3 mb-2 text-gray-800">Tables</h1>
          <p class="mb-4">Table Pendaftar Gelombang 3</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Gelombang 3</h6>
            </div>
            <div class="card-body">
