...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=3 AND jadwal.paralel_bahasa_ing='C';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 3 - Bahasa Inggris-C</title>
