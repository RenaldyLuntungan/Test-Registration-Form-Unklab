...
$result = mysqli_query($mysqli, "SELECT * FROM collages,jadwal WHERE collages.id_collages=jadwal.id_collages AND jadwal.gelombang=3 AND jadwal.paralel_kesehatan='A';");
$no=1;
?>
...
<head>
  ...
  <title>Gelombang 3 - Kesehatan-A</title>
...
Waktu &emsp;&emsp;: &ensp;20/06/2020 11:00<br>
